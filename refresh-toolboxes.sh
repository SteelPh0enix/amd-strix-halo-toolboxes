...
TOOLBOXES["llama-rocm-10.0-strix-llama"]="docker.io/kyuz0/amd-strix-halo-toolboxes:rocm-10.0-strix-llama --device /dev/dri --device /dev/kfd --group-add video --group-add render --group-add sudo --security-opt seccomp=unconfined"
...
function usage() {
  ...
  echo "  - llama-rocm-10.0-strix-llama"
